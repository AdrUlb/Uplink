...
DArray<char*>* App::ListExistingGames() { TODO_ABORT; }
void App::SetNextLoadGame(const char* name) { TODO_ABORT; }
void App::LoadGame(const char* name) { TODO_ABORT; }
void App::SaveGame(const char* name) { TODO_ABORT; }
void App::RetireGame(const char* name) { TODO_ABORT; }
